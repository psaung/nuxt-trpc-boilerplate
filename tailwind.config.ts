  ...
  theme: {
    extend: {
      ...
      colors: {
        primary: '#FFF',
        secondary: '#F9FAFB',
        product_default: '#9CA3AF',
        action_primary: '#2A3EB1',
        product_sold: '#4CAF50',
        from_gradient: 'rgb(39, 13, 148)',
        to_gradient: 'rgb(58, 166, 228)',
        theme_bg_color:
          'linear-gradient(to right, rgb(39, 13, 148) 0%, rgb(58, 166, 228) 100%)',
        logo_text: '#000',
        btn_color: '#e79d19',
        grey: {
          0: '#FFFFFF',
